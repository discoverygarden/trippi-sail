...
public class SesameConnector extends TriplestoreConnector {
    ...
    public void open() throws TrippiException {
        if (closed) {
            ...
            TriplestoreSessionPool sessionPool = new ConfigurableSessionPool(sessionFactory,
            ...
            UpdateBuffer updateBuffer = new MemUpdateBuffer(ConfigUtils.getRequiredInt(config, "bufferSafeCapacity"),
            ...
            try {
                ...
                m_writer = new ConcurrentTriplestoreWriter(sessionPool, updateSession.getAliasManager(), updateSession,
                        updateBuffer, tripleIteratorFactory, ConfigUtils.getRequiredInt(config, "autoFlushBufferSize"),
